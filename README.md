...
##### Clone the Repo
    ...
    $ git clone https://github.com/donrichards/dev-setup.git && cd dev-setup
...
**For more customization, you can [clone](#clone-the-repo) or [fork](https://github.com/donrichards/dev-setup/fork) the repo and tweak the `.dots` script and its associated components to suit your needs.**
...
#### Running without Git
    ...
    $ curl -O https://raw.githubusercontent.com/donrichards/dev-setup/master/.dots && ./.dots [Add ARGS Here]

#### Scripts

* [.dots](https://github.com/donrichards/dev-setup/blob/master/.dots)
    * Runs specified scripts
* [bootstrap.sh](https://github.com/donrichards/dev-setup/blob/master/bootstrap.sh)
    * Syncs dev-setup to your local home directory `~`
* [osxprep.sh](https://github.com/donrichards/dev-setup/blob/master/osxprep.sh)
    * Updates OS X and installs Xcode command line tools
* [brew.sh](https://github.com/donrichards/dev-setup/blob/master/brew.sh)
    * Installs common Homebrew formulae and apps
* [osx.sh](https://github.com/donrichards/dev-setup/blob/master/osx.sh)
    * Sets up OS X defaults geared towards developers
* [pydata.sh](https://github.com/donrichards/dev-setup/blob/master/pydata.sh)
    * Sets up python for data analysis
* [aws.sh](https://github.com/donrichards/dev-setup/blob/master/aws.sh)
    * Sets up Spark, Hadoop MapReduce, and Amazon Web Services
* [datastores.sh](https://github.com/donrichards/dev-setup/blob/master/datastores.sh)
    * Sets up common data stores
* [web.sh](https://github.com/donrichards/dev-setup/blob/master/web.sh)
    * Sets up JavaScript web development
* [android.sh](https://github.com/donrichards/dev-setup/blob/master/android.sh)
    * Sets up Android development
...
I encourage you to read through Section 1 so you have a better idea of what each installation script does.  The following discussions describe in greater detail what is executed when running the [.dots](https://github.com/donrichards/dev-setup/blob/master/.dots) script.
...
To sync dev-setup to your local home directory without Git, run the following:
    ...
    $ cd ~; curl -#L https://github.com/donrichards/dev-setup/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,LICENSE}
...
You could also use `~/.extra` to override settings, functions, and aliases from the dev-setup repository, although it’s probably better to [fork the dev-setup repository](https://github.com/donrichards/dev-setup/fork).
...
**Note**: **I strongly encourage you read through the commented [osx.sh source file](https://github.com/donrichards/dev-setup/blob/master/osx.sh) and tweak any settings based on your personal preferences.  The script defaults are intended for you to customize.**  For example, if you are not running an SSD you might want to change some of the settings listed in the SSD section.
...
Let's set up some basic configuration. Download the [.gitconfig](https://raw.githubusercontent.com/donrichards/dev-setup/master/.gitconfig) file to your home directory:

    $ cd ~
    $ curl -O https://raw.githubusercontent.com/donrichards/dev-setup/master/.gitconfig
...
**Note**: On a Mac, it is important to remember to add `.DS_Store` (a hidden OS X system file that's put in folders) to your `.gitignore` files. You can take a look at this repository's [.gitignore](https://github.com/donrichards/dev-setup/blob/master/.gitignore) file for inspiration.  Also check out GitHub's [collection of .gitignore templates](https://github.com/github/gitignore).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/donrichards/data-science-ipython-notebooks/master/images/README_1200x800.gif">
</p>
...
* [data-science-ipython-notebooks](https://github.com/donrichards/data-science-ipython-notebooks)
* [interactive-coding-challenges](https://github.com/donrichards/interactive-coding-challenges)
...
Refer to the following [Numpy IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#numpy).
...
Refer to the following [pandas IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#pandas).
...
Refer to the following [matplotlib IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#matplotlib).
...
Refer to the following [matplotlib with Seaborn IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#matplotlib).
...
Refer to the following [scikit-learn IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#scikit-learn).
...
Refer to the following [SciPy IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#statistical-inference-scipy).
...
[Coming Soon] Refer to the following [Flask IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#).
...
[Coming Soon] Refer to the following [Bokeh IPython Notebooks](https://github.com/donrichards/data-science-ipython-notebooks#).
...
Refer to the following [Spark IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#spark).
...
Refer to the following [mrjob IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#mapreduce-python).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/donrichards/data-science-ipython-notebooks/master/images/aws.png">
</p>
<br/>

[Awesome AWS](https://github.com/donrichards/awesome-aws) is a curated list of awesome AWS libraries, open source repos, guides, blogs, and other resources.  It's a great way to stay up-to-date with the various aws-backed and community-led efforts geared towards AWS.
...
*Repos not on `The Fiery Meter of AWSome` can still be awesome, see [A Note on Repo AWSomeness](https://github.com/donrichards/awesome-aws/blob/master/CONTRIBUTING.md#a-note-on-repo-awsomeness).*
...
Refer to the following [AWS CLI IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the [repo link](https://github.com/donrichards/saws).
...
Refer to the following [Boto IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the following [s3cmd IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the following [S3DistCp IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the following [s3-parallel-put IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the following [Redshift IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the following [Kinesis IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Refer to the following [Lambda IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
[Coming Soon] Refer to the following [AWS Machine Learning IPython Notebook](https://github.com/donrichards/data-science-ipython-notebooks#aws).
...
Bug reports, suggestions, and pull requests are [welcome](https://github.com/donrichards/dev-setup/issues)!
